...
N_blk=200; % The number of blocks used in the measurement phase
...
for ii=1:N_run1
    ...
    [E_ave(ii),E_err(ii),savedFile]=PPMC_Bos(Lx,Ly,Lz,Lx,kx,ky,kz,U(ii),Uab,jj,tx,ty,tz,deltau,N_wlk,N_blksteps,N_eqblk,N_blk,itv_pc,itv_nrm,itv_Em,suffix);
end
